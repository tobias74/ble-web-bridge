...
const RESERVED_COMMAND_TYPES = new Set([
  ...
  'bike.resistance',
  'bike.targetPower',
  'bike.targetHeartRate',
  'bike.targetEnergy',
  'bike.targetSteps',
  'bike.targetStrides',
  'bike.targetDistance',
  'bike.targetTrainingTime',
  'bike.targetTimeTwoHeartRateZones',
  'bike.targetTimeThreeHeartRateZones',
  'bike.targetTimeFiveHeartRateZones',
  'bike.wheelCircumference',
  'bike.spinDown',
  'bike.targetCadence',
  'treadmill.speed',
  'treadmill.incline'
